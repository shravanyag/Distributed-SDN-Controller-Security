...
class SimpleMonitor(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.portMaps = {"s1": ["h1", "h2"]}

        # Mapping from datapath ids to switch names
        self.dpids = {123917682136716: "s1"}
...
###########################################
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        if SimpleMonitor.REPORT_STATS:
            print "-------------- Flow stats for switch Milkyway ---------------"
        ...
        for stat in sorted([flow for flow in body if flow.priority == 1],
            ...
            if rate > 100:
                ...
                victim = str(eth_dst)
                print "XXXXXXXXXXXXX DoS attack on controller from switch Milkyway XXXXXXXXXXXXX"
